...
def create_user(user_id, user_n_posts, user_name, user_bio, state_of_origin, gender, ethnicity, religion, political_view,
                user_interests, age_interval, job, peft_model, tokenizer, create_posts=True, llm_provider="lmstudio", real_posts=None,
                dst_dir="users"):
    """
    ...
    if create_posts:
        ...
        prompt = (f"Your username is {user_name}. You are a {gender} and your age is in the interval {age_interval}. You are an "
                  ...
                  "* Your posts must be relevant to your passions and opinions."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--llm_provider", type=str, help="How the LLM generating the posts is deployed (llama cpp or lmstudio)", choices=["lmstudio", "llama.cpp"])
    parser.add_argument("--model_name", required=False, help="Name of the model to use, in case you want to load it in the code")
    ...
    parser.add_argument("--real_posts_text_column", type=str, default="content", help="Name of the column in the csv file containing the content")
    parser.add_argument("--real_posts_path", type=str, help="Path to the file containing the real posts to use for learning style")
